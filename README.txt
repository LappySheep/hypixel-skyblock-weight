...
This number is representative of the player's progress, and therefore should scale from various aspects;
  ...
  ; proportionality and realism from gameplay - is it unrealistic to assume that a 'top' player would have this aspect?

Overall, we can assign scores and ratings to aspects of gameplay, which can then be weighted to a finalised amount.


For now, only the skills/slayers/dungeons aspects will be made public. Perhaps in future I will release the rest.
...
Note that calculations in this repository are *not* in retaliation to Senither in any way, this was originally made far before - I am simply making calculations more public.
